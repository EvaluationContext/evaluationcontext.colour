...
=== "Syntax"
    ...
    |:---:|:---:|:---:|---|
    | startHexColour | <span class="type-label string">STRING</span> | :material-check: | The starting hex color (e.g., "<span style="color: #FF0000">■</span> #FF0000") |
    | endHexColour | <span class="type-label string">STRING</span> | :material-check: | The ending hex color (e.g., "<span style="color: #0000FF">■</span> #0000FF") |
